...
<div class="row">
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">สร้าง review</h4>
        ...
        <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputName1" placeholder="แพรวา สุธรรมพงษ์" name="name" value="{{ old('name') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputName1" placeholder="รองหัวหน้าทีมบีทรี" name="position" value="{{ old('position') }}">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleTextarea1" placeholder="สิ่งที่ทำให้ผมประทับใจมากที่สุดคือ ผมสามารถที่จะเลือกและเปรียบเทียบรถที่จะเช่าได้จากผู้ให้บริการหลายเจ้าพร้อมๆกัน ..." name="detail" rows="4">{{ old('detail') }}</textarea>
          </div>
