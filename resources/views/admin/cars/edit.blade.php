      ...
      <div class="card-body">
        ...
        <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputName1" placeholder="บริษัทที่ให้บริการรถยนต์เช่า" name="name" value="{{$objs->name}}">
            @if ($errors->has('name'))
            ...
            <div class="form-group">
              <label for="exampleSelectGender">ประเภทรถ*</label>
                <select class="form-control" name="sub_cat_id" id="exampleSelectGender">
                  ...
                  <option value="{{$u->id}}" @if( $objs->sub_cat_id == $u->id)
                              selected='selected'
                              @endif>{{$u->sub_name}}</option>
                  @endforeach
                  @endif
                </select>
              </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputCity1" name="code" value="{{$objs->code}}">
            @if ($errors->has('code'))
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputCity1" name="price" value="{{$objs->price}}">
            @if ($errors->has('price'))
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="deposit" name="deposit" value="{{$objs->deposit}}">
          ...
          <div class="form-group">
            <label for="exampleSelectGender">ระบบเกียร์*</label>
              <select class="form-control" name="grear" id="exampleSelectGender">
                <option value="เกียร์อัตโนมัติ" @if( $objs->grear == 'เกียร์อัตโนมัติ')
                                    selected='selected'
                                    @endif
                                    >เกียร์อัตโนมัติ</option>
                                    <option value="เกียร์ธรรมดา" @if( $objs->grear == 'เกียร์ธรรมดา')
                                    selected='selected'
                                    @endif>เกียร์ธรรมดา</option>
              </select>
            </div>
            ...
            <div class="form-group">
              <label for="exampleSelectGender">ประเภทประกันรถยนต์*</label>
                <select class="form-control" name="insurance" id="exampleSelectGender">
                  <option value="ประกันภัยรถยนต์ประเภท 1" @if( $objs->insurance == 'ประกันภัยรถยนต์ประเภท 1')
                                    selected='selected'
                                    @endif
                                    >ประกันภัยรถยนต์ประเภท 1</option>
                                    <option value="ประกันภัยรถยนต์ประเภท 2+" @if( $objs->insurance == 'ประกันภัยรถยนต์ประเภท 2+')
                                    selected='selected'
                                    @endif
                                    >ประกันภัยรถยนต์ประเภท 2+</option>
                                    <option value="ประกันภัยรถยนต์ประเภท 3+" @if( $objs->insurance == 'ประกันภัยรถยนต์ประเภท 3+')
                                    selected='selected'
                                    @endif
                                    >ประกันภัยรถยนต์ประเภท 3+</option>
                                    <option value="ประกันภัยรถยนต์ชั้น 2 ธรรมดา" @if( $objs->insurance == 'ประกันภัยรถยนต์ชั้น 2 ธรรมดา')
                                    selected='selected'
                                    @endif
                                    >ประกันภัยรถยนต์ชั้น 2 ธรรมดา</option>
                                    <option value="ประกันภัยรถยนต์ชั้น 3 ธรรมดา" @if( $objs->insurance == 'ประกันภัยรถยนต์ชั้น 3 ธรรมดา')
                                    selected='selected'
                                    @endif
                                    >ประกันภัยรถยนต์ชั้น 3 ธรรมดา</option>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputCity1" name="total_p" value="{{$objs->total_p}}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputCity1" name="bags" value="{{$objs->bags}}">
                @if ($errors->has('bags'))
              ...
              <div class="form-group">
                <label for="exampleInputCity1">รูปหลักรถเช่า*</label>
                <img src="{{url('assets/back/image/car/'.$objs->image)}}" class="img-fluid rounded">
              </div>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="summernote" name="service" rows="4">{{$objs->service}}</textarea>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="summernote2" name="detail" rows="4">{{$objs->detail}}</textarea>
          </div>
