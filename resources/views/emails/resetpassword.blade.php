						...
						<tr>
                            ...
                            <!-- Start Space -->
								...
								<!-- Section 1 Starts / Logo social ================  -->
									...
									<table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" bgcolor="#292D3E">
									<tbody>
										<tr>
											<td height="26">&nbsp;</td>
										</tr>
											...
											<td height="25" valign="middle" align="center">
												...
												<table  align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr>
                              <tr>
                                 <td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:18px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">
                                   <strong>Siamrentalcars </strong><br />
                                 </td>
                               </tr>
																				...
																				<tbody>
																					...
																					<tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
																							Please press the "reset password" button to create a new password. <br /> www.siamrentalcars.com</td>
																					</tr>
																					<tr>
																					...
																					<tr>
																						<td align="center">
																							<table cellspacing="0" cellpadding="0" border="0" align="center">
																								<tbody>
																									<tr>
																										<td align="center" style="border-radius:3px;color: #1b1717;display:block;font-family: Arial, Helvetica,
                                                    sans-serif;font-size:12px;line-height:12px;text-align:center;text-decoration:none;padding-top: 10px;padding-bottom: 10px;
                                                    width:110px;-webkit-text-size-adjust:none;background-color: #ffd430;">
																...
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">
																			<strong>Copyright © 2020 siamrentalcars.com</strong><br />
																		</td>
																	</tr>
																</tbody>
															</table>
